...
import { Search, CheckCircle, XCircle, Eye, FileText, Calendar, TrendingUp, Trash2 } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 lg:p-10">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    <StatCard icon={FileText} label="Total Verifications" value={stats.total} color="bg-blue-500" />
                    <StatCard icon={CheckCircle} label="Genuine" value={stats.genuine} color="bg-emerald-500" />
                    <StatCard icon={XCircle} label="Forged" value={stats.forged} color="bg-red-500" />
                    <StatCard icon={TrendingUp} label="Avg Confidence" value={`${stats.avgConfidence}%`} color="bg-purple-500" />
                </motion.div>
                ...
                >
                    {loading ? (
                        <div className="p-12 text-center">
                            <div className="w-10 h-10 border-4 border-slate-700 border-t-emerald-500 rounded-full animate-spin mx-auto mb-4"></div>
                            ...
                            <table className="w-full">
                                ...
                                <tr className="bg-slate-800/50 border-b border-slate-700">
                                    <th className="px-6 py-4 text-left text-xs font-semibold text-slate-400 uppercase tracking-wider">
                                        <div className="flex items-center gap-2"><Calendar className="w-4 h-4" />Date & Time</div>
                                    </th>
                                    ...
                                    >
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="flex-1 min-w-[100px]">
                                                    <div className="h-2 bg-slate-700 rounded-full overflow-hidden">
                                                        <div
                                                            className={`h-full ${item.status === 'GENUINE' ? 'bg-emerald-500' : 'bg-red-500'}`}
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <button
                                                ...
                                                title="Delete"
                                            >
                                                <Trash2 className="w-5 h-5 text-slate-500 group-hover:text-red-400 transition-colors" />
                                            </button>
                                        </td>
                                    </motion.tr>
                                ))}
